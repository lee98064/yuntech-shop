          ...
          <v-list-item>
              ...
              <v-list-item-content>
                  ...
                  <v-list-item-subtitle>X1
                      <v-btn plain color="#1ab394" small>Notes
                          ...
                          <v-row>
                              <v-col cols="12" md="12">
                                  <v-list-item three-line class="text-center mt-1">
                                      <v-list-item-content>
                                          <div>
                                              <v-icon :color="active ? '#1ab394' : 'black'">fas fa-money-bill-wave</v-icon>
                                          </div>
                                          <v-list-item-subtitle
                          ...
                          <v-row>
                              <v-col cols="12" md="12">
                                  <v-list-item three-line class="text-center mt-1">
                                      <v-list-item-content>
                                          <div>
                                              <v-icon :color="active ? '#1ab394' : 'black'">fas fa-credit-card</v-icon>
                                          </div>
                                          <v-list-item-subtitle
                          ...
                          <v-row>
                              <v-col cols="12" md="12">
                                  <v-list-item three-line class="text-center mt-1">
                                      <v-list-item-content>
                                          <div>
                                              <v-icon :color="active ? '#1ab394' : 'black'">fas fa-qrcode</v-icon>
                                          </div>
                                          <v-list-item-subtitle
