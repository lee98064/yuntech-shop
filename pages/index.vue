                    ...
                    <v-list-item three-line class="text-center">
                      <v-list-item-content>
                        ...
                        <v-list-item-subtitle
                          :class="active ? 'brown--text' : 'black--text'"
                          class="caption mt-2"
                          >Milk Based</v-list-item-subtitle
                        >
                      </v-list-item-content>
                    </v-list-item>
                  </v-col>
        ...
        <v-card flat class="rounded-lg mx-5">
          <v-list-item three-line>
            ...
            <v-list-item-content>
              ...
              <v-list-item-subtitle class="mt-1"
                >Sweet chocolate with coffee, milk, and whipped
                cream</v-list-item-subtitle
              >
              <strong class="mt-3"> $4.51 </strong>
            </v-list-item-content>
          </v-list-item>
