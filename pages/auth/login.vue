          ...
          <v-window v-model="step">
            <v-window-item :value="1">
              <v-row>
                  ...
                  <v-card-text class="mt-12">
                    ...
                    <v-row align="center" justify="center">
                      <v-col cols="12" sm="8" class="p-5">
                        ...
                        <v-btn color="#1AB394" dark block tile>Log in</v-btn>
                ...
                <v-col cols="12" md="6" class="rounded-bl-xl" style="background-color: #1AB394">
            ...
            <v-window-item :value="2">
              <v-row>
                <v-col cols="12" md="6" class="rounded-br-xl" style="background-color: #1AB394">
                  <div style="text-align: center; padding: 180px 0">
                    <v-card-text class="white--text">
                  ...
                  <v-card-text class="mt-12">
                    ...
                    <v-row align="center" justify="center">
                      <v-col cols="12" sm="8">
                        ...
                        <v-btn color="#1AB394" dark block tile>Sign up</v-btn>
